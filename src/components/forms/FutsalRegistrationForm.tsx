...
interface FutsalRegistrationFormProps {
    eventId: string;
    eventTitle: string;
...
export default function FutsalRegistrationForm({ eventId, eventTitle, pricePerPerson }: FutsalRegistrationFormProps) {
    ...
    return (
        <Card>
            <div className="p-6">
                ...
                <p className="text-gray-600 mb-6">Fill out the form below to register for this futsal event</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {/* Futsal Specific Details */}
                    <div className="border-b pb-4">
                        <h3 className="text-lg font-semibold text-gray-900 mb-4">Futsal Details</h3>
                        ...
                        <div className="space-y-4">
                            <Select
                                ...
                                onChange={handleInputChange}
                                required
                                options={[{ value: '', label: 'Select...' }, ...futsalPositions]}
                            />
