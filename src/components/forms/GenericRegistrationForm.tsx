...
export default function GenericRegistrationForm({ eventId, eventTitle, pricePerPerson }: GenericRegistrationFormProps) {
    ...
    return (
        <Card>
            <div className="p-6">
                ...
                <p className="text-gray-600 mb-6">Fill out the form below to register for this event</p>
                    ...
                    <div className="border-b pb-4">
                        ...
                        <div className="space-y-4">
                            <Select
                                ...
                                onChange={handleInputChange}
                                required
                                options={[{ value: '', label: 'Select...' }, ...genericPositions]}
                            />
