...
interface CyclingRegistrationFormProps {
    eventId: string;
    eventTitle: string;
...
export default function CyclingRegistrationForm({ eventId, eventTitle, pricePerPerson }: CyclingRegistrationFormProps) {
    ...
    return (
        <Card>
            <div className="p-6">
                ...
                <p className="text-gray-600 mb-6">Fill out the form below to register for this cycling event</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="border-b pb-4">
                        <h3 className="text-lg font-semibold text-gray-900 mb-4">Cycling Details</h3>
                        ...
                        <div className="space-y-4">
                            <Select
                                ...
                                onChange={handleInputChange}
                                required
                                options={[{ value: '', label: 'Select...' }, ...cyclingCategories]}
                            />
                    ...
                    {/* Photo Upload */}
                    <div className="border-b pb-4">
                        <h3 className="text-lg font-semibold text-gray-900 mb-4">Participant Photo</h3>
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            <Select
                                label={`The contribution per participant will be around ${pricePerPerson || '800 - 1200'} Rs.`}
                                name="paymentMethod"
                            ...
                            <label className="flex items-center space-x-2">
                                ...
                                <span className="text-sm font-medium">
                                    I assure that I'll reach on time and will not cause any trouble for other participants. <span className="text-red-500">*</span>
                                </span>
                            </label>
                        </div>
                    </div>
