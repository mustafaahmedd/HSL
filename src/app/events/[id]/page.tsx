                        ...
                        <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                            <div className="p-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-purple-300 mb-2">Location</h4>
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        {event.amenities.length > 0 && (
                                            <div>
                                                <h4 className="text-lg font-semibold text-purple-300 mb-4">Amenities</h4>
                                        ...
                                        {event.facilities.length > 0 && (
                                            <div>
                                                <h4 className="text-lg font-semibold text-purple-300 mb-4">Facilities</h4>
                                                <ul className="space-y-2">
                            ...
                            <div className="p-6">
                                ...
                                <div className="space-y-3">
                                    ...
                                    {event.contactInfo.phone && (
                                        <div>
                                            <h4 className="text-purple-300 font-semibold">Phone</h4>
                                            <a href={`tel:${event.contactInfo.phone}`} className="text-blue-300 hover:text-blue-200">
                                                {event.contactInfo.phone}
                                            </a>
                                        </div>
                                    )}
